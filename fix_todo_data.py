...
# 获取教师姓名
cursor.execute("SELECT id, 姓名 FROM teacher_basic_info WHERE id = 293")
...
# 更新待办工作数据，添加教师姓名和任务数
todo_updates = [
    (1, '待审核的职工退休申请', teacher_name, 5, 0),
    (2, '待处理的职务升降申报', teacher_name, 3, 0),
    (3, '待确认的信息变更', teacher_name, 5, 0),
    (4, '待导出的报表', teacher_name, 2, 0),
]
