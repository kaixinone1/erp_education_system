...
def create_tables():
    ...
    # 创建索引
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_高龄老人补贴信息_身份证号码 ON 高龄老人补贴信息(身份证号码)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_高龄老人补贴信息_状态 ON 高龄老人补贴信息(状态)")
    ...
    # 创建索引
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_死亡登记信息_身份证号码 ON 死亡登记信息(身份证号码)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_死亡登记信息_死亡日期 ON 死亡登记信息(死亡日期)")
    ...
    # 创建索引
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_高龄提醒记录_身份证号码 ON 高龄提醒记录(身份证号码)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_高龄提醒记录_状态 ON 高龄提醒记录(状态)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_高龄提醒记录_提醒日期 ON 高龄提醒记录(提醒日期)")
    ...
    # 创建索引
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_高龄提醒处理记录_提醒ID ON 高龄提醒处理记录(提醒ID)")
