      ...
      <div class="panel-content">
        ...
        <div class="upload-section">
          ...
          <el-upload
            ...
            :limit="1"
            accept=".xlsx,.xls,.csv,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
          >
            ...
            <template #tip>
              <div class="el-upload__tip">
                支持 Excel (.xlsx, .xls)、CSV 和 Word (.doc, .docx) 格式文件
              </div>
            </template>
          </el-upload>
        </div>
